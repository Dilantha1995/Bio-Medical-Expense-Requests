...
const CHECKPOINTS = [
  ...
  { table: "notifications", column: null, introducedIn: "notifications" },
  { table: "designation_options", column: null, introducedIn: "configurable designations" },
  { table: "advance_requests", column: "payment_status", introducedIn: "payment processing" },
  { table: "advance_requests", column: "deleted_at", introducedIn: "delete with audit trail" },
  { table: "users", column: "can_process_payments", introducedIn: "payment processing permission" },
  { table: "advance_requests", column: "payment_rejection_reason", introducedIn: "payment rejection" },
  { table: "option_lists", column: null, introducedIn: "configurable option lists" },
  { table: "shipping_expense_requests", column: null, introducedIn: "shipping expense requests" },
  { table: "advance_requests", column: "expected_end_date", introducedIn: "task reminders & extensions" },
  { table: "roles", column: null, introducedIn: "configurable roles" },
  { table: "roles", column: "can_view_reports", introducedIn: "per-tab role permissions" },
];
