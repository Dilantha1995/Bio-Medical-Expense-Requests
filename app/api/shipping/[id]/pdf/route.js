...
import ShippingFormPDF from "@/lib/pdf/ShippingFormPDF";
...
export async function GET(req, { params }) {
  try {
    ...
    const buffer = await renderToBuffer(
      React.createElement(ShippingFormPDF, { doc, companyLogoBase64: companyLogo, companyName, timezone: appSettings.timezone, currency: appSettings.currency })
    );
